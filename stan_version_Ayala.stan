functions {
  ...
  vector[2] dydt;
  dydt[1] = alpha_A * (y[1]) * (1 - (y[1] / kappa_A)^nu_A - beta_AB * y[2] / kappa_B);
  dydt[2] = alpha_B * (y[2]) * (1 - (y[2] / kappa_B)^nu_B - beta_BA * y[1] / kappa_A);
...
parameters {
  ...
  real<lower=230,upper=380> epsilon_A_mean;
  ...
  vector<lower=230,upper=380>[n_wells] epsilon_A;
