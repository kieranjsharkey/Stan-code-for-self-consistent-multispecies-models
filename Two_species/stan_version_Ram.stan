functions {
  ...
  dydt[1] = alpha_tau * (y[1]) * (1 - (y[1] / kappa_tau)^nu_tau - beta_tau_omega * (y[2] / kappa_omega)^nu_omega);
  dydt[2] = alpha_omega * (y[2]) * (1 - (y[2] / kappa_omega)^nu_omega - beta_omega_tau * (y[1] / kappa_tau)^nu_tau);
